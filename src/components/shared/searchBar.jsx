...
const SearchBar = ({ placeholder = "Search tasks, projects...", value, onChange }) => {
  ...
  return (
    <div className="relative group">
      ...
      <input
        ...
        value={value}
        onChange={onChange}
        className={`rounded-xl pl-10 pr-4 py-2.5 w-80 focus:outline-none transition-all duration-300 ${
          isDark 
